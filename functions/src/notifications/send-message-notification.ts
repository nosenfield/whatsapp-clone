/**
 * Send Message Notification Cloud Function
 * 
 * Triggers when a new message is created and sends push notifications
 * to all conversation participants except the sender.
 */
